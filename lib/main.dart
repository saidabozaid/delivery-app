...
void main() async {
  ...
  await Supabase.initialize(
    ...
    anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZsc3p3bWd0a2l5c3Z4cHZ6Z3RiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjU3OTM2OTAsImV4cCI6MjA0MTM2OTY5MH0.6Q7R5eJx_example_replace_with_real_key',
  );
...
class _MainShellState extends State<MainShell> {
  ...
  Widget _buildCustomer(){
    ...
    return Center(child: Text("حسابي - سعيد - 6 اكتوبر"));
  }
  Widget _buildDriver(){
    return ListView(
      padding: EdgeInsets.all(16),
